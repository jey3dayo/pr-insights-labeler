...
PR Insights Labelerプロジェクトの現在のREADME.mdは717行の詳細なドキュメントで、初見ユーザーには情報過多になっており、必要な情報にアクセスしにくい状態です。本要件では、README.mdを200-300行程度に簡素化し、詳細情報をdocs/ディレクトリに分離することで、ユーザビリティとメンテナンス性を向上させます。

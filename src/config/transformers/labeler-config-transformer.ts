...
export function parseLabelerConfig(config: unknown): Result<LabelerConfigTransformResult, ConfigurationError> {
  ...
  assignIfDefined(
    normalized,
    'categoryLabeling',
    getOptionalField<LabelerConfig['categoryLabeling']>(source, CATEGORY_LABELING_FIELD),
  );
  assignIfDefined(normalized, 'exclude', getOptionalField<LabelerConfig['exclude']>(source, EXCLUDE_FIELD));
  assignIfDefined(normalized, 'labels', getOptionalField<LabelerConfig['labels']>(source, LABELS_FIELD));
  assignIfDefined(normalized, 'runtime', getOptionalField<LabelerConfig['runtime']>(source, RUNTIME_FIELD));
...
function parseLanguageField(rawLanguage: unknown): Result<LabelerConfig['language'] | undefined, ConfigurationError> {
...
function parseSummaryField(rawSummary: unknown): Result<LabelerConfig['summary'] | undefined, ConfigurationError> {
...
function parseSizeField(rawSize: unknown): Result<LabelerConfig['size'] | undefined, ConfigurationError> {
...
function parseRiskField(rawRisk: unknown): Result<LabelerConfig['risk'] | undefined, ConfigurationError> {
...
function getOptionalField<T>(source: Record<string, unknown>, fieldName: string): T | undefined {
...
function assignIfDefined<K extends keyof LabelerConfig>(

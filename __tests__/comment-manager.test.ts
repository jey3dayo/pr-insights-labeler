  ...
  describe('generateCommentBody', () => {
    describe('i18n support', () => {
      it('should generate comment with English header and footer', () => {
        ...
        expect(body).toContain('Generated by [PR Insights Labeler](https://github.com/jey3dayo/pr-insights-labeler)');
      });
      ...
      it('should generate comment with Japanese header and footer', () => {
        ...
        expect(body).toContain('[PR Insights Labeler](https://github.com/jey3dayo/pr-insights-labeler)により生成');
    ...
    it('should generate success message when no violations', () => {
      ...
      expect(body).toContain('Excluded from Analysis: **1**');

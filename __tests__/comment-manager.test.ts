  ...
  describe('generateCommentBody', () => {
    describe('i18n support', () => {
      it('should generate comment with English header and footer', () => {
        ...
        expect(body).toContain('Generated by [PR Labeler](https://github.com/jey3dayo/pr-labeler)');
      });
      ...
      it('should generate comment with Japanese header and footer', () => {
        ...
        expect(body).toContain('[PR Labeler](https://github.com/jey3dayo/pr-labeler)により生成');
